...
const config: CodegenConfig = {
  ...
  generates: {
    'libs/rick-and-morty/characters/data-access/src/lib/__generated__/models.ts':
      {
    ...
    'libs/rick-and-morty/characters/data-access/src/lib/__generated__/operations.ts':
      {
