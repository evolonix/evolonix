      ...
      {isLoading && !character ? (
        ...
        <>
          <DetailsHeader>
            ...
            <DetailsActions
              isLoading={isLoading}
              editUrl={`/admin/rick-and-morty/characters/${character.id}/edit`}
            ...
            <dl className="grid w-full gap-2 lg:grid-cols-[auto_1fr]">
              ...
              <dd>
                {character.location?.id ? (
                  <Link
                    href={`/admin/rick-and-morty/locations/${character.location?.id}`}
              ...
              <dd>
                {character.origin?.id ? (
                  <Link
                    href={`/admin/rick-and-morty/locations/${character.origin?.id}`}
                    className="group hover:text-cyan-700 dark:hover:text-cyan-500"
                  >
